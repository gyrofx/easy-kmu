...
const defaultWebServerEnv = {
  EKMU_WEB_SESSION_SECRET: 'UAbzjdfPoiIKMKRiragYQR6USOBTntfouQEOm1kmZzUqpjOK7ZSSeKKlLa7Ho29JRfwe1UJhy2z',
...
describe('initOptsInternal', () => {
  ...
  it('parses the port', () => {
    expect(initOptsInternal({ ...defaultWebServerEnv, EKMU_WEB_PORT: '5555' }).port).toBe(5555)
  })
  ...
  describe('session opts', () => {
    it('parses the secret', () => {
      expect(
        initOptsInternal({
          ...defaultWebServerEnv,
          EKMU_WEB_SESSION_SECRET: 'dyMJ3JoaNdvsF4tMwqX33QaSJP7wGta6XwaCOeO00HyPUlnEuhOLg',
        }).session,
